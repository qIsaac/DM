...
public interface Instruction{
        ...
        int queryAdaptor(String name,Set<Donator> recorde,List<Donation>  donations,List<String> lists);
        void process(String line,Set<Donator> recorade,List<String> lists);
        void process(String line,Set<Donator> recorade,List<Donation>  donations,List<String> lists);
        }